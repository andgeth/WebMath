...
<i:html title="theory">
<c:url value="eulerSystem.html" var="eulerUrl" />
<c:url value="counteulerSystem.html" var="counteulerSystem" />
<c:url value="/eulerSystem.html" var="onlineUrl" />
<c:url value="/help.html" var="helpUrl" />
<c:url value="Метод Эйлера" var="name" />
<c:url value="/theoryEulerSystem.html" var="theoryUrl" />
