        ...
        <form action="<c:url value="/runge-kutta-system" />" method="post">
            <fieldset id="inputs">
                <div class="row form-group">
                    ...
                    <div class="col-sm-8"><input id="functions" name="functions" class="form-control"
                                                 value="${functions}" title="Например: x+(cos(y/3^0.5); z-sin(x/2)" autofocus required></div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-8"><input id="y0" name="y0" class="form-control" value="${y0}"
