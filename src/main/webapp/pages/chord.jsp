        ...
        <form action="<c:url value="/chord"/>" method="post">
            <fieldset id="inputs">
                <div class="row form-group">
                    ...
                    <div class="col-sm-8"><input type="text" id="function" name="function" title="Например: x+2 или x^2-2" class="form-control" required></div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    <div class="col-sm-4"><label for="x1">Начальное приближение x2:</label></div>
