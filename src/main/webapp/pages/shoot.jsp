...
<i:html>
    ...
    <form action="<c:url value="/shoot"/>" method="post">
        <table class="table">
            ...
            <tr>
                <td><label for="initValue">Значение функций в начальной точки для 1 и 2 задач:</label></td>
                <td><input type="text" id="initValue" name="initValue" required></td>
            </tr>
            <tr>
                <td><label for="shootAngles">Значения производных в начальной точки для 1 и 2 задач:</label></td>
                <td><input type="text" id="shootAngles" name="shootAngles" required></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="e">Точность:</label></td>
                <td><input type="text" pattern="^([-]?)([0-9]+)([.]?)([0-9]*)" id="e" name="e" required></td>
            </tr>
            <tr>
