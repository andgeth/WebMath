...
public abstract class MathFunction implements Changeable, MathExpression {
    ...
    static public MathExpression getInstance(String content, int pos) {
        ...
        if (type.equals("")) {
            ...
            switch (Type.valueOf(type.toLowerCase())) {
                case root: m = new Root(expr); break;
                case log: m = new Logarithm(expr); break;
                case sin: m = new Sinus(expr, pos); break;
                case cos: m = new Cosines(expr, pos); break;
                case tg: m = new Tangent(expr, pos); break;
                case ctg: m = new Cotangent(expr); break;
                case sec: m = new Secant(expr, pos); break;
                case csc: m = new Cosecant(expr); break;
                case asin: m = new ArcSine(expr); break;
                case acos: m = new ArcCosine(expr); break;
                case atg: m = new ArcTangent(expr); break;
                case actg: m = new ArcCotangent(expr); break;
                case asec: m = new ArcSecant(expr); break;
                case acsc: m = new ArcCosecant(expr); break;
                case sh: m = new HypSine(expr); break;
                case ch: m = new HypCosine(expr); break;
                case th: m = new HypTangent(expr, pos); break;
                case cth: m = new HypCotangent(expr); break;
                case sech: m = new HypSecant(expr, pos); break;
                case csch: m = new HypCosecant(expr, pos); break;
                default: m = null;
            }
        }
        if (content.charAt(0) == '-') {
